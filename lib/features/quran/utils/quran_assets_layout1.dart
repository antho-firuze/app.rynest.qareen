...
part 'quran_assets_layout1.g.dart';

final _kLogName = "QURAN-ASSETS-LAYOUT-1";

@Riverpod(keepAlive: true)
class QuranAssetsLayout1 extends _$QuranAssetsLayout1 {
  String appPath = '';
  ...
  Future initialize() async {
    ...
    // check is file assets exists,
    // if not, then download and extract to given folder
